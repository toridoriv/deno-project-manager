...
export const DEFAULT_EMOJI_GROUP = {
  group: "misc",
...
export const GITMOJI_MAPPING = {
  ...
  "Miscellaneous": DEFAULT_EMOJI_GROUP,
  "Release": RELEASE_EMOJI_GROUP,
};

export const GITMOJI_GROUPS = [
  GITMOJI_MAPPING.Added,
  GITMOJI_MAPPING.Changed,
  GITMOJI_MAPPING["Breaking Changes"],
  GITMOJI_MAPPING.Deprecated,
  GITMOJI_MAPPING.Removed,
  GITMOJI_MAPPING.Fixed,
  GITMOJI_MAPPING.Security,
  RELEASE_EMOJI_GROUP,
];
